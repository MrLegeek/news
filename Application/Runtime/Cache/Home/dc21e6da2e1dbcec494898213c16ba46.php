...
<head>
    ...
    <style>
        ...
        .wss{width:97% ;height:500px;position: absolute;top: 30px;left: 16px;}
...
<script src="/news/Public/Home/js/jquery.min.js" type="text/javascript"></script>
    ...
    <div  class="wzssl">
        <div class="wzct">
            ...
            <form action="<?php echo U('search');?>" method="post" >
                ...
                <div class="bd1">
                    起始时间：<input id="txtBeginDate"name="begin_time" value="<?php echo (session('zkxf_begin_time')); ?>" style="background-color: rgb(204,232,207)" />
                    <!--<input type="date" name="begin_time" value="<?php echo (session('zkxf_begin_time')); ?>">-->
                </div>
                <div class="bd1">
                    终止时间：<input id="txtEndDate" name="end_time"  value="<?php echo (session('zkxf_end_time')); ?>" style="background-color: rgb(204,232,207)" />
                    <!--<input type="date" name="end_time" value="<?php echo (session('zkxf_end_time')); ?>">-->
                </div>
                <div class="bd1"> 时间格式：<span style="font-size: 12px">2017-09-19</span></div>
