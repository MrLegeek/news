...
<div class="page-container">
	<form action="/news/index.php/Admin/Lmsg/replay/id/27" method="post" class="form form-horizontal" id="form-user-add">
		<p class="text-c"><span class="c-red">*</span>留言回复：</p>
		<div class="row cl">
			<div class="formControls text-c col-xs-6 col-sm-6">
				<textarea name="replay_msg"  cols=60 rows=6></textarea>
			</div>
		</div>
		<div class="row cl">
			<div class="col-9 col-offset-4">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
                <input class="btn btn-default radius" type="button" type="text" onclick="layer_close()" value="&nbsp;&nbsp;取消&nbsp;&nbsp;">
            </div>
		</div>
	</form>
</div>
