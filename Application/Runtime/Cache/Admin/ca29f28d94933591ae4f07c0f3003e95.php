...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l"><a href="javascript:;" onclick="batchDel('/index.php/Admin/File/batchDel')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<?php if(is_array($fielsList)): foreach($fielsList as $key=>$vo): ?><tr class="text-c va-m check-tr">
					...
					<td class="f-14 td-manage">
						...
						onClick="file_del(this,'/index.php/Admin/File/fileDel','<?php echo ($vo["id"]); ?>')"title="删除">
