...
<div class="page-container">
	<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive" >
			...
			<?php if(is_array($lmsg)): foreach($lmsg as $key=>$vo): ?><tr class="text-c va-m check-tr">
					...
					<!--	<?php if($vo['status'] == 0): ?><a href="javascript:;" onclick="replay_msg('回复消息','/news/index.php/Admin/Lmsg/replay/id/<?php echo ($vo["id"]); ?>',500,380)"> <span class="label label-danger radius">点击回复消息</span></a>
							<?php else: ?>
							<a href="javascript:;" onclick="replay_look('回复内容','/news/index.php/Admin/Lmsg/replay_look/id/<?php echo ($vo["id"]); ?>',500,300)"><span class="label label-success radius">查看回复内容</span></a><?php endif; ?>-->
					</td>
				   <td>
					   <?php if($vo['status'] == 2): ?><a  style="text-decoration:none" onclick="replay_msg('回复消息','/news/index.php/Admin/Lmsg/replay/id/<?php echo ($vo["id"]); ?>',500,380)" href="javascript:;" title='审核未通过'><span class="label label-danger radius">回复消息</span></a></case>
						<?php else: ?>
						  <a href="javascript:;" onclick="replay_look('回复内容','/news/index.php/Admin/Lmsg/replay_look/id/<?php echo ($vo["id"]); ?>',500,300)"><span class="label label-success radius">查看回复内容</span></a></case><?php endif; ?>
				   </td>
					<td class="f-14 td-manage">
					  <a style="text-decoration:none" class="ml-5"
						onClick="lmsg_del(this,'/news/index.php/Admin/Lmsg/lmsg_del','<?php echo ($vo["id"]); ?>')"title="删除">
